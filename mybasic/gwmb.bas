...
4 dim pgm$(1000) : ' (0) used for work line; programs stored here
5 dim vars(26)   : ' variables a-z
6 dim atarry(500)  : ' the @ array
...
83 print "+---------------------- Tiny Basic Help (mybasic)---------------------+"
...
344 return
345 ' leave the double quote as the beginning of the string, so it won't get confused with other tokens
