...
public class Program {
  ...
  public static void docmd() {
    while (true) {
      if (tracing && tok.charAt(0) != ':') System.out.println("[" + curline + "] " + tok + " " + thech + " " + thelin.charAt(textp - 1));
      switch (tok) {
  ...
  public static void help() {
    System.out.println("+---------------------- Tiny Basic Help (C#)--------------------------+" );
  ...
  public static int expression(int minprec) {
    ...
    } else if (tok.equals("rnd") || tok.equals("irnd")) { nexttok(); n = random.nextInt(parenexpr() - 1) + 1;
